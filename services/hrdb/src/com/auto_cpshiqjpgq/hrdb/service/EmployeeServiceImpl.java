...
package com.auto_cpshiqjpgq.hrdb.service;
...
import com.auto_cpshiqjpgq.hrdb.Employee;
import com.auto_cpshiqjpgq.hrdb.Vacation;
	...
	public Employee create(Employee employee) {
        ...
        if(employeesForManagerId != null) {
            for(Employee _employee : employeesForManagerId) {
                _employee.setEmployeeByManagerId(employeeCreated);
                LOGGER.debug("Creating a new child Employee with information: {}", _employee);
                create(_employee);
            }
        }
        ...
        if(vacations != null) {
            for(Vacation _vacation : vacations) {
                _vacation.setEmployee(employeeCreated);
                LOGGER.debug("Creating a new child Vacation with information: {}", _vacation);
                vacationService.create(_vacation);
            }
        }
